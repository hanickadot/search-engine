...
function(coverage_report_after EVENT TARGET)
	...
	add_custom_command(TARGET ${EVENT} POST_BUILD 
		...
		COMMAND ${LLVM_COV} show $<TARGET_FILE:${TARGET}> -format html -instr-profile=coverage.profdata "-ignore-filename-regex=\"(external/.*|tests/.*|cthash/internal/assert[.]hpp)\""  -output-dir ${CMAKE_BINARY_DIR}/report -show-instantiations=true -show-expansions=false -show-line-counts -Xdemangler c++filt -Xdemangler -n -show-branches=percent -tab-size=4 -path-equivalence=/,${CMAKE_SOURCE_DIR} 
